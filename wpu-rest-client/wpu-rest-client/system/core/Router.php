...
class CI_Router {
    ...
    public $config;
    public $uri; // Tambahan properti untuk menghindari deprecated warning di PHP 8.2+
    public $routes = [];
    public $class = '';
    public $method = 'index';
    public $directory = '';
    ...
    protected function _set_routing() {
        ...
        if ($this->enable_query_strings) {
            ...
            if (!isset($this->directory) && isset($_GET[$_d])) {
                $dir = trim($_GET[$_d], " \t\n\r\0\x0B/");
                $this->uri->filter_uri($dir);
    ...
    protected function _set_default_controller() {
        ...
        if (!file_exists($filepath)) {
            show_error("Default controller '{$class}' not found.");
        }
    ...
    protected function _validate_request($segments) {
        ...
        while ($c-- > 0) {
            $test = $this->directory . ucfirst($this->translate_uri_dashes ? str_replace('-', '_', $segments[0]) : $segments[0]);
    ...
    public function set_directory($dir, $override = FALSE) {
